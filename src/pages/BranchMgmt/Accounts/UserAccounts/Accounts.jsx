                    ...
                    <div className='account-user-filter'>
                        ...
                        <div className="account-users-top">
                            ...
                            <div className="UserRoleField">
                                ...
                                <InputDropdown id="role" name="role" editable={true} options={jsonData.dropDownOptions.userRoleOptions} />
                            </div>
                            <div className="EmpidField">
                                <InputLabel color="#0377A8">Emp ID</InputLabel>
                                <InputField id="empID" name="empID" width="15.625em" editable={true} borderRadius="0.625em" style={{ border: "1px solid #8D9093" }}></InputField>
                            </div>
                        </div>
                        <hr className="line" />
